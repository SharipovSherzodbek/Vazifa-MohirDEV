...
System.Console.WriteLine(" \t Homework 2");
  int[] myArray = { -2, 3, -5, 334, 45, 432, 556, 32, 34, 43, 343, 4, 35, 644, 32, 8, };
  int arrayMax = myArray.Max();
  int arrayMin = myArray.Min();5
  
  int minMax = arrayMax * arrayMin;
  Console.WriteLine("Multiplying the max and min values ​​of the arrays is equal to " +minMax);


System.Console.WriteLine(" \t Homework 3");
